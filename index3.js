...
if ($("h1").text()==="Press A Key to Start"){
  ...
  setTimeout( function() {
        if(randomNumber===1){
          var color = new Audio("sounds/green.mp3");
  color.play();
 ...
 /* alert(randomArray); */ 
      ...
      if(randomNumber===2){
        var color = new Audio("sounds/red.mp3");
        color.play();
 ...
 /* alert(randomArray); */  },190); }else
      if(randomNumber===3){
        var color = new Audio("sounds/yellow.mp3");
        color.play();
 ...
 /* alert(randomArray); */  },190);}else 
      if(randomNumber===4){
        var color = new Audio("sounds/blue.mp3");
        color.play();
 ...
 /* alert(randomArray); */ },190); }},450);
    ...
    if (($("h1").text())===(("Game Over, Press Any Key to Restart")|| ("Press A Key to Start"))){
...
function clickedButtonsDirectly(){
    ...
    if ($("h1").text()==="Press A Key to Start"){
     ...
     }else{alert("Please press any Keyboard key to start a new game");
     }
